...
class TestWorkerRaceCondition(unittest.TestCase):
    ...
    def test_stale_worker_cleared_emits_debug_log(self):
        """RC-3 observable path: stale guard emits stale_worker_cleared debug log."""
        from pypost.ui.presenters.tabs_presenter import TabsPresenter
        from pypost.models.settings import AppSettings
        ...
        stale_logs = [r for r in caplog.records if "stale_worker_cleared" in r.message]
