...
| [`McpClientPresenter`](file:///home/src/pypost/ui/presenters/mcp_client_presenter.py) | `pypost/ui/presenters/mcp_client_presenter.py` | Local MCP Client draft Connect / Disconnect / teardown (no `MCPClientService` until MCP-TM-3). See [mcp_client_draft_tab.md](mcp_client_draft_tab.md). |
