# PYPOST-294: Close debt — New-tab metrics source validation

## Goals

Close follow-up debt from [PYPOST-32](https://pypost.atlassian.net/browse/PYPOST-32): new-tab metrics source validation.
