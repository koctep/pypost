...
Debt follow-up from [PYPOST-32](https://pypost.atlassian.net/browse/PYPOST-32): Plus button and Ctrl+N new-tab parity.
...
- `ai-tasks/PYPOST-297/10-requirements.md`
...
- `ai-tasks/PYPOST-297/60-tech-debt.md`
