# PYPOST-297: Close debt — Plus button and Ctrl+N new-tab parity

## Goals

Close follow-up debt from [PYPOST-32](https://pypost.atlassian.net/browse/PYPOST-32): plus button and ctrl+n new-tab parity.
