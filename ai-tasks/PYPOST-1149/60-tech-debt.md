...
| NON-BLOCKER — pre-existing | `tests/test_ui_wait.py` (entire module — native segfault during collection/execution) | PySide6/Shiboken segfault in isolated subprocess (`QT_QPA_PLATFORM=offscreen`); repro: `make test PYTEST_ARGS=tests/test_ui_wait.py` or `pytest tests/test_ui_wait.py` | [PYPOST-1152](https://pypost.atlassian.net/browse/PYPOST-1152) (related: [PYPOST-1117](https://pypost.atlassian.net/browse/PYPOST-1117)) |
