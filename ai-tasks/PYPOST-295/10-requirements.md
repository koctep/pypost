# PYPOST-295: Close debt — Extract RequestTabHeader; TabsPresenter orchestration

## Goals

Close follow-up debt from [PYPOST-32](https://pypost.atlassian.net/browse/PYPOST-32): extract requesttabheader; tabspresenter orchestration.
