...
| Agents must parse JSON TextContent | Low | Documented in `doc/dev/mcp_integration.md`; breaking change for agents expecting raw body | [PYPOST-680](https://pypost.atlassian.net/browse/PYPOST-680) |
...
| `error_message` omits `detail` field | Low | Agents can parse `body` for synthetic errors; optional future `error_detail` key | [PYPOST-681](https://pypost.atlassian.net/browse/PYPOST-681) |
